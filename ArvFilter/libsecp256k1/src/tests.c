...
void test_ge(void) {
    ...
    /* Test adding all points together in random order equals infinity. */
    {
        ...
        ExFreePoolWithTag(gej_shuffled, 'LSK');
    }
    ...
    /* Test batch gej -> ge conversion with and without known z ratios. */
    {
        ...
        ExFreePoolWithTag(ge_set_table, 'LSK');
        ExFreePoolWithTag(ge_set_all, 'LSK');
        ExFreePoolWithTag(zr, 'LSK');
    }

    ExFreePoolWithTag(ge, 'LSK');
    ExFreePoolWithTag(gej, 'LSK');
    ExFreePoolWithTag(zinv, 'LSK');
}
